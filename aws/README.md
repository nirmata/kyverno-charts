...
helm install kyverno --namespace kyverno ./kyverno-charts/aws --set rbac.create=true --set rbac.serviceAccount.name=kyverno --set rbac.serviceAccount.annotations."eks\.amazonaws\.com\/role-arn"=<role-arn>
```
...
$ helm install kyverno --namespace kyverno ./kyverno-charts/aws --set aws.licenseConfigSecretName=<license-secret>
```
