...
helm install kyverno ./kyverno-charts/aws --namespace kyverno --create-namespace --set admissionController.rbac.serviceAccount.create false --set admissionController.rbac.serviceAccount.annotations."eks\.amazonaws\.com\/role-arn"=<role-arn>
```
...
$ helm install kyverno ./kyverno-charts/aws --namespace kyverno --set aws.licenseConfigSecretName=<license-secret>
```
...
```console
helm template kyverno --namespace=kyverno ./kyverno-charts/aws --create-namespace --set licenseManager.licenseKey=<license key>[,licenseManager.apiKey=<api key>] > kyverno.yaml
...
| webhooksCleanup.image | string | `ghcr.io/nirmata/kubectl:1.29.0` | `kubectl` image to run commands for deleting webhooks. |
